    ...
    <AnimatePresence mode="wait" initial={false}>
      {status === "success" ? (
        ...
        >
          ...
          <p className={styles.formNote}>We&apos;ll email you when the PSP network opens. No spam. See our <a href="/privacy" className={styles.formNoteLink}>Privacy Policy</a>.</p>
        </motion.form>
      )}
    </AnimatePresence>
  );
